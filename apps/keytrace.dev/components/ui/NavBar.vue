<template>
  <nav class="sticky top-0 z-40 backdrop-blur-lg bg-kt-root/80 border-b border-zinc-800/50">
    <div class="max-w-5xl mx-auto flex items-center justify-between px-4 h-14">
      <NuxtLink to="/" class="flex items-center gap-2">
        ...
        <span class="px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wider text-amber-400 bg-amber-500/15 border border-amber-500/30 rounded">alpha</span>
      </NuxtLink>
